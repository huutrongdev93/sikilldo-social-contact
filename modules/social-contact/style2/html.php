<div class="animated fadeInLeft social-contact-box social-contact-style2 social-<?php echo SocialContact::config('pc-position');?> social-mb-<?php echo SocialContact::config('mb-position');?>" xmlns:https="http://www.w3.org/1999/xhtml">
    <ul>
