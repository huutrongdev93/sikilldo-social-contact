<?php
$styles = PhoneContact::style();
$active = PhoneContact::config('active');
?>
<div class="row">
    <div class="col-md-3">
        <div class="ui-title-bar__group" style="padding-bottom:5px;">
            <h3 class="ui-title-bar__title" style="font-size:20px;">Hiển thị</h3>
            <p style="margin-top: 10px; margin-left: 1px; color: #8c8c8c">Quản lý hiển thị & vị trí button hotline trên website</p>
        </div>
    </div>
    <div class="col-md-9">
        <div class="box">
            <div class="box-content" style="padding:10px;">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        $Form->add('phoneContact[pc-show]', 'switch', ['label' => 'Hiển thị trên desktop'], PhoneContact::config('pc-show'));
                        $Form->add('phoneContact[pc-position]', 'select-img', [
                            'label' => 'Vị trí',
                            'options' => [
                        ...
                        $Form->add('phoneContact[pc-vertical]', 'range', ['label' => 'Canh lề dọc', 'min' => 0, 'max' => 1000], PhoneContact::config('pc-vertical'));
                        $Form->add('phoneContact[pc-horizontal]', 'range', ['label' => 'Canh lề ngang', 'min' => 0, 'max' => 1000], PhoneContact::config('pc-horizontal'));
                        $Form->html(false);
                        ?>
                    </div>
                    <div class="col-md-6">
                        <?php
                        $Form->add('phoneContact[mb-show]', 'switch', ['label' => 'Hiển thị trên mobile'], PhoneContact::config('mb-show'));
                        $Form->add('phoneContact[mb-position]', 'select-img', [
                            'label' => 'Vị trí',
                            'options' => [
                                'bottomLeft'    => [ 'label' => '', 'img'   => Admin::imgLink('bottomLeft.png')],
                                'bottomRight'   => [ 'label' => '', 'img'   => Admin::imgLink('bottomRight.png')],
                        ...
                        ], PhoneContact::config('mb-position'));
                        $Form->add('phoneContact[mb-vertical]', 'range', ['label' => 'Canh lề dọc', 'min' => 0, 'max' => 200], PhoneContact::config('mb-vertical'));
                        $Form->add('phoneContact[mb-horizontal]', 'range', ['label' => 'Canh lề ngang', 'min' => 0, 'max' => 200], PhoneContact::config('mb-horizontal'));
                        $Form->html(false);
                        ?>
                    </div>
                </div>
