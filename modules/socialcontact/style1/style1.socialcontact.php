<?php
function scb_socialcontact_style1_register($style) {
    $style['scb_socialcontact_style1'] = ['label' => 'Style 1'];
    return $style;
}
add_filter('scb_socialcontact_style', 'scb_socialcontact_style1_register');

class scb_socialcontact_style1 {
    static public function admin_demo() {
        Template::img(Url::base(SCB_PATH.'/assets/images/socialcontact/demo-style1.png'));
    }
